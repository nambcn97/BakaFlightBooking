...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cangiua col-sm-13 " style="text-align: center">
        <div class="row">
            ...
            <div style="text-align: left" class="col-sm-2">
                <div class="list-group">
                    ...
                    <asp:HyperLink BackColor="Aquamarine" CssClass="list-group-item" runat="server" NavigateUrl="~/Account/UserFlightBooking.aspx">Choose Your Flight</asp:HyperLink>
        ...
        <br />
                ...
                <asp:Button CssClass="btn btn-danger navbar-form navbar-right form-control" ID="btnContinue" runat="server" Text="Continue" Height="40px" Width="150px" PostBackUrl="UserPassenger.aspx" />
            </div>
        </div>
        </div>
</asp:Content>
