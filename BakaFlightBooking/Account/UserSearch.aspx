...
<asp:Content ID="Content1" ContentPlaceHolderID="CustomHead" runat="server">
    <%--Css tự động generate ra do kéo thả--%>
    <style type="text/css">
        .auto-style8 {
            height: 40px;
            width: 120px;
                ...
                <div class="cangiua " style="text-align: center">
                    ...
                    <asp:Table BorderWidth="0" Style="border: none;" runat="server">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell>
                                <asp:RequiredFieldValidator ID="validateFrom" runat="server" ErrorMessage="This fill is required!" ControlToValidate="drpDestination_Airport" CssClass="text-danger"></asp:RequiredFieldValidator><br />
                            </asp:TableCell>
                            <asp:TableCell>
                            </asp:TableCell>
                            <asp:TableCell>
                                <asp:RequiredFieldValidator ID="validateTo" runat="server" ErrorMessage="This fill is required!" ControlToValidate="drpOrigin_Airport" CssClass="text-danger"></asp:RequiredFieldValidator><br />
                            </asp:TableCell>
                            <asp:TableCell></asp:TableCell>
                            <asp:TableCell>
                                <asp:RequiredFieldValidator ID="validateDepart" runat="server" ErrorMessage="This fill is required!" ControlToValidate="txtDepart" CssClass="text-danger"></asp:RequiredFieldValidator><br />
                            </asp:TableCell>
                            <asp:TableCell></asp:TableCell>
                            <asp:TableCell>
                                <asp:RequiredFieldValidator ID="validateArrival" runat="server" ErrorMessage="This fill is required!" ControlToValidate="txtArrival" CssClass="text-danger"></asp:RequiredFieldValidator><br />
                            </asp:TableCell>
                        </asp:TableRow>


                        <%--Hàng search thông tin chuyến bay --%>
                        <asp:TableFooterRow>
                            <asp:TableCell CssClass="auto-style10">
                        <asp:Label runat="server" CssClass="control-label">From</asp:Label></asp:TableCell>
                            ...
                            <asp:TableCell CssClass="auto-style10">To</asp:TableCell>
                            <asp:TableCell CssClass="auto-style11">
                            ...
                            <asp:TableCell CssClass="auto-style10">Depart</asp:TableCell>
                            <asp:TableCell CssClass="auto-style11">
