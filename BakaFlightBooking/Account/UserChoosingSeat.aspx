<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserChoosingSeat.aspx.cs" Inherits="BakaFlightBooking.Account.UserChoosingSeat" %>
    ...
    <div class="cangiua col-sm-13 " style="text-align: center">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <div class="cangiua">
                    ...
                    <table style="max-width: 600px; text-align: left" class="auto-style11">
                        ...
                        <tr>
                            ...
                            <td class="auto-style10">
                                <asp:TextBox ID="txtDepartFlyingTo" runat="server" CssClass="form-control" Width="138px" ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                ...
                <h2>Arrival Flight Seat Options</h2>
                <div class="cangiua">
                    <!--Hiện thông tin từ search, txtFlyingFrom sẽ truyền dữ liệu từ drpOrigin_Airport, txtFlyingTo sẽ truyền dữ liệu từ drpDestination_Airport-->
                    <table style="max-width: 600px; text-align: left" class="auto-style11">
                        <tr class="alightTable">
                        ...
                        <tr>
                            ...
                            <td class="auto-style10">
                                <asp:TextBox ID="TextBox2" runat="server" CssClass=" form-control" Width="138px" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td class="auto-style8">Flying To
                            </td>
                            <td class="auto-style10">
                                <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" Width="138px" ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style10">
                                <asp:TextBox ID="TextBox4" runat="server" CssClass=" form-control" Width="138px" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td class="auto-style8">Arrival Time
                            </td>
                            <td class="auto-style10">
                                <asp:TextBox ID="TextBox5" runat="server" CssClass=" form-control" Width="138px" ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <br />
                ...
                <asp:Button CssClass="btn btn-danger navbar-form navbar-right form-control" ID="btnContinue" runat="server" Text="Continue" Height="40px" Width="150px" PostBackUrl="UserCheckOut.aspx" />
            </div>
        </div>
    </div>
</asp:Content>
