<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="AdminPanel.Pages.AddUser" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-group">
        ...
        <asp:TextBox runat="server" ID="txtWallet" CssClass="form-control" />
