...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:DropDownList runat="server" ID="drpTravelClasses" CssClass="form-control" ItemType="DbLibrary.Models.TravelClass" SelectMethod="GetTravelClasss" AppendDataBoundItems="true" DataValueField="Travel_Class_ID" DataTextField="Name" />
    </div>
    <div class="form-group">
